...
function cuss_choice() {  // New function called cuss_choice that doesn't take any parameters
    // Since MASH is a special case, give it its own list
...
function cussTwo_choice() { //  New function called cusstwo_choice that doesn't take any parameters
    // Since cussTwo is a special case, give it its own list
...
function cussThree_choice() { //  New function called cussThree_choice that doesn't take any parameters
    // Since cussThree is a special case, give it its own list
...
function fill_in_answers(answers) {
    ...
    var cuss = document.querySelector('#cuss');
    var cussOne = document.querySelector('#cussOne');
    var cussTwo = document.querySelector('#cussTwo');
    var cussThree= document.querySelector('#cussThree');
    ...
    cuss.innerText = answers['cuss'];
    cussOne.innerText = answers['cussOne'];
    cussTwo.innerText = answers['cussTwo'];
    cussThree.innerText = answers['cussThree'];
    ...
    cuss.innerHTML = answers.cuss;
    cussOne.innerHTML = answers.cussOne;
    cussTwo.innerHTML = answers.cussTwo;
    cussThree.innerHTML = answers.cussThree;
...
function handle_submission(evt) {
    ...
    var answers = {
        'mash': mash_choice(),
        'cuss': cuss_choice(),
        'cussOne': cussOne_choice(),
        'cussTwo': cussTwo_choice(),
        'cussThree': cussThree_choice(),
